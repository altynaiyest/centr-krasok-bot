...
if not TELEGRAM_TOKEN or not GROQ_API_KEY:
    logger.error("❌ Ошибка: проверь TELEGRAM_BOT_TOKEN и GROQ_API_KEY в файле .env")
    exit(1)
...
async def send_qrcode(chat_id, context):
    # файл qrcode.png должен лежать в папке с ботом
